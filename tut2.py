...
from tensorflow.keras.layers import Dense, GlobalAveragePooling2D, Flatten, LSTM, Dense, Dropout
...
DISCOUNT = 0.99
epsilon = 1
EPSILON_DECAY = 0.955 ## 0.9975 or so later
MIN_EPSILON = 0.001
...
class CarEnv:
    ...
    def collision_data(self,event):
        self.collision.hist.append(event)
