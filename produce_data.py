...
class World(object):
    ...
    def process_img_rgb(self, image):
        ...
        image.save_to_disk("/home/edvard/Carla/CARLA_0.9.11/PythonAPI/examples/segcam/testcam.jpg",
...
################################################       
        ...
        blueprint = self.blueprint_library.filter("model3")[0]
        self.vehicle = blueprint
